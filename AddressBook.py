...
class AddressBook(UserList):
    ...
    def search(self, pattern, category):
        ...
        for account in self.data:
            if category_new == 'phones':
                ...
                result.append(account)
        if not result:
            self.display('There is no such contact in address book!')
        return result
    ...
    def edit(self, contact_name, parameter, new_value):
        ...
        try:
            ...
            self.display('Incorrect parameter! Please provide correct parameter')
        except NameError:
            self.display('There is no such contact in address book!')
        else:
    ...
    def congratulate(self):
        ...
        for day, names in congratulate.items():
            if names:
