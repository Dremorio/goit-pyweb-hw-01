...
class Bot:
    def __init__(self):
        ...
        self.ui = ConsoleInterface()  # Створюємо екземпляр класу ConsoleInterface
        ...
        if action == 'add':
            ...
            for account in result:
                if account['birthday']:
                    ...
                    self.ui.display(result_str)  # Використовуємо новий метод для виведення
        elif action == 'edit':
            ...
            self.ui.display(self.book.congratulate())  # Використовуємо новий метод для виведення
        elif action == 'view':
            self.ui.display(str(self.book))  # Використовуємо новий метод для виведення
        elif action == 'exit':
            pass
        else:
            self.ui.display("There is no such command!")  # Використовуємо новий метод для виведення
